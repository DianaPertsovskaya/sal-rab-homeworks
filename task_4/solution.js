...
function parseProducts(json) {
   let data = JSON.parse(json); // Аргументом функции является JSON
    ...
    let products = data.products; // Преобразуйте строку json, переданную как аргумент функции,
    return products; // в объект с помощью функции JSON.parse(json)
...
let products = parseProducts; // Выполните функцию parseProducts, передав в неё json - аргумент функции и запишите результат в переменную products
